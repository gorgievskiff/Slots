...
namespace Slots
{
    public partial class Slots : Form
    {
        ...
        public Slots()
        {
            ...
            row1col1.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
            row1col2.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
            row1col3.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
            row2col1.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
            row2col2.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
            row2col3.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
            row3col1.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
            row3col2.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
            row3col3.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\slots.jpg");
        ...
        private void newSpin(int n, PictureBox pb)
        {
            ...
            else if (n >= 700 && n < 750)
            {
                pb.SizeMode = PictureBoxSizeMode.StretchImage;
                pb.ClientSize = new Size(200, 200);
                pb.Image = new Bitmap(@"C:\Users\Dario\source\repos\Slots\Slots\img\jackpot.jpg");
            }
            else if(n >= 750 && n < 850)
            {
                pb.SizeMode = PictureBoxSizeMode.StretchImage;
        ...
        private void btnSpin_Click(object sender, EventArgs e)
        {
            ...
            int num4 = random.Next(1000);
            int num5 = random.Next(1000);
            int num6 = random.Next(1000);
            int num7 = random.Next(1000);
            int num8 = random.Next(1000);
            int num9 = random.Next(1000);
            ...
            newSpin(num1, row1col1);
            newSpin(num2, row1col2);
            newSpin(num3, row1col3);
            newSpin(num4, row2col1);
            newSpin(num5, row2col2);
            newSpin(num6, row2col3);
            newSpin(num7, row3col1);
            newSpin(num8, row3col2);
            newSpin(num9, row3col3);
        ...
        {
            btnSpin.BackColor = Color.LightSkyBlue;
